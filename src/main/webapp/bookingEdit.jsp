...
<fieldset class="form-group">
<label>Date</label> <input type="text" value="<c:out value='${booking.date}' />" class="form-control" name="date"  required="required" placeholder="Enter in DD/MM/YYYY">
</fieldset>
<fieldset class="form-group">
<label>Time</label> <input type="text" value="<c:out value='${booking.time}' />" class="form-control" name="time" placeholder="Enter in 12HR formart">
</fieldset>
